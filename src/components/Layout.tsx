import { Building2, Users, BedDouble, Calendar, Settings, BarChart3, DollarSign, FileText } from "lucide-react";
...
const navigation = [
  ...
  { name: 'Rooms', href: '/rooms', icon: BedDouble, current: false },
        ...
        <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-card px-6 pb-4 shadow-strong">
          <div className="flex h-16 shrink-0 items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-foreground">HostelHub</h1>
