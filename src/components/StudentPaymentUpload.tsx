...
import { Upload, Loader2, CheckCircle, AlertCircle, X, Camera, CreditCard } from "lucide-react";
import { useState, useRef } from "react";
import { useToast } from "@/hooks/use-toast";
import Tesseract from 'tesseract.js';

interface StudentPaymentUploadProps {
  open: boolean;
  onClose: () => void;
}

const StudentPaymentUpload = ({ open, onClose }: StudentPaymentUploadProps) => {
...
export default StudentPaymentUpload;